...
Alternatively [use an existing MQTT client](#using-an-existing-mqtt-client) to start your own MQTT-thread without each entity generating their own client and therefore thread/task.
